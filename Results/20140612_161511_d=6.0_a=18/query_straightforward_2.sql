...
ON edge5x9."5"  = edge5x8."5"  AND edge5x9."9"  = edge8x9."9" ) 
ON edge7x10."7"  = edge6x7."7"  AND edge7x10."10"  = edge4x10."10" ) 
ON edge2x11."2"  = edge2x6."2"  AND edge2x11."11"  = edge4x11."11" ) 
ON edge6x10."6"  = edge1x6."6"  AND edge6x10."10"  = edge4x10."10" ) 
ON edge3x11."3"  = edge1x3."3"  AND edge3x11."11"  = edge4x11."11" ) 
ON edge2x5."2"  = edge2x6."2"  AND edge2x5."5"  = edge5x8."5" ) 
ON edge9x10."9"  = edge8x9."9"  AND edge9x10."10"  = edge4x10."10" ) 
ON edge0x1."0"  = edge0x3."0"  AND edge0x1."1"  = edge1x6."1" ) 
ON edge1x7."1"  = edge1x6."1"  AND edge1x7."7"  = edge6x7."7" ) 
ON edge4x6."4"  = edge4x11."4"  AND edge4x6."6"  = edge1x6."6" ) 
ON edge3x9."3"  = edge1x3."3"  AND edge3x9."9"  = edge8x9."9" ) 
WHERE (1=1)
