...
FROM 
( edge9x10 JOIN 
( SELECT edgeP11."4", edgeP11."9", edgeP11."10"
FROM 
( edge3x9 JOIN 
( SELECT edgeP1."3", edgeP1."4", edgeP1."9", edgeP1."10"
FROM 
( edge3x11 JOIN 
( SELECT edgeP7."3", edgeP7."4", edgeP7."9", edgeP7."10", edgeP7."11"
FROM 
( edge0x1 JOIN 
( SELECT edgeP6."0", edgeP6."1", edgeP6."3", edgeP6."4", edgeP6."9", edgeP6."10", edgeP6."11"
FROM 
( edge1x7 JOIN 
( SELECT edgeP5."0", edgeP5."1", edgeP5."3", edgeP5."4", edgeP5."7", edgeP5."9", edgeP5."10", edgeP5."11"
FROM 
( edge6x10 JOIN 
( SELECT edgeP8."0", edgeP8."1", edgeP8."3", edgeP8."4", edgeP8."6", edgeP8."7", edgeP8."9", edgeP8."10", edgeP8."11"
FROM 
( edge2x5 JOIN 
( edge2x11 JOIN 
( edge7x10 JOIN 
...
ON edge4x6."4"  = edge4x11."4"  AND edge4x6."6"  = edge1x6."6" ) 
...
ON edge2x10."2"  = edgeP8."2"  AND edge2x10."10"  = edgeP8."10" ) 
...
WHERE (1=1) ) AS edgeP1
ON edge3x11."3"  = edgeP1."3"  AND edge3x11."11"  = edgeP1."11" ) 
