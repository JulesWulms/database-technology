...
FROM 
( edge1x9 JOIN 
( SELECT edgeP8."1", edgeP8."5", edgeP8."9"
FROM 
( edge3x7 JOIN 
( SELECT edgeP0."1", edgeP0."3", edgeP0."5", edgeP0."7", edgeP0."9"
FROM 
( edge8x9 JOIN 
( SELECT edgeP11."1", edgeP11."3", edgeP11."5", edgeP11."7", edgeP11."8", edgeP11."9"
FROM 
( edge0x3 JOIN 
( edge7x8 JOIN 
( edge0x1 JOIN 
( SELECT edgeP12."0", edgeP12."1", edgeP12."3", edgeP12."5", edgeP12."7", edgeP12."8", edgeP12."9"
FROM 
( edge0x11 JOIN 
( edge8x11 JOIN 
( edge1x8 JOIN 
( edge3x8 JOIN 
( SELECT edgeP10."0", edgeP10."1", edgeP10."3", edgeP10."5", edgeP10."7", edgeP10."8", edgeP10."9", edgeP10."11"
FROM 
( edge0x12 JOIN 
( edge3x9 JOIN 
( SELECT edgeP2."0", edgeP2."1", edgeP2."3", edgeP2."5", edgeP2."7", edgeP2."8", edgeP2."9", edgeP2."11", edgeP2."12"
FROM 
( edge1x10 JOIN 
( SELECT edgeP4."0", edgeP4."1", edgeP4."3", edgeP4."5", edgeP4."7", edgeP4."8", edgeP4."9", edgeP4."10", edgeP4."11", edgeP4."12"
FROM 
( edge2x5 JOIN 
( edge0x2 JOIN 
( SELECT edgeP6."0", edgeP6."1", edgeP6."2", edgeP6."3", edgeP6."5", edgeP6."7", edgeP6."8", edgeP6."9", edgeP6."10", edgeP6."11", edgeP6."12"
FROM 
( edge3x4 JOIN 
( edge0x4 JOIN 
( SELECT edge0x9."0", edge1x2."1", edge2x7."2", edge1x3."3", edge4x5."4", edge5x10."5", edge2x7."7", edge4x8."8", edge0x9."9", edge5x10."10", edge6x11."11", edge4x12."12"
FROM 
( edge4x6 JOIN 
( edge5x12 JOIN 
( edge5x8 JOIN 
...
ON edge2x3."2"  = edge2x7."2"  AND edge2x3."3"  = edge1x3."3" ) 
ON edge2x12."2"  = edge2x7."2"  AND edge2x12."12"  = edge4x12."12" ) 
ON edge7x9."7"  = edge2x7."7"  AND edge7x9."9"  = edge0x9."9" ) 
ON edge1x5."1"  = edge1x2."1"  AND edge1x5."5"  = edge5x10."5" ) 
ON edge2x6."2"  = edge2x7."2"  AND edge2x6."6"  = edge5x6."6" ) 
ON edge2x9."2"  = edge2x7."2"  AND edge2x9."9"  = edge0x9."9" ) 
ON edge3x11."3"  = edge1x3."3"  AND edge3x11."11"  = edge6x11."11" ) 
ON edge5x8."5"  = edge5x10."5"  AND edge5x8."8"  = edge4x8."8" ) 
ON edge5x12."5"  = edge5x10."5"  AND edge5x12."12"  = edge4x12."12" ) 
ON edge4x6."4"  = edge4x5."4"  AND edge4x6."6"  = edge5x6."6" ) 
WHERE (1=1) ) AS edgeP6
ON edge0x4."0"  = edgeP6."0"  AND edge0x4."4"  = edgeP6."4" ) 
ON edge3x4."3"  = edgeP6."3"  AND edge3x4."4"  = edgeP6."4" ) 
WHERE (1=1) ) AS edgeP4
