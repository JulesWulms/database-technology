...
ON edge0x4."0"  = edge0x9."0"  AND edge0x4."4"  = edge4x5."4" ) 
ON edge3x4."3"  = edge1x3."3"  AND edge3x4."4"  = edge4x5."4" ) 
ON edge0x2."0"  = edge0x9."0"  AND edge0x2."2"  = edge2x7."2" ) 
ON edge2x5."2"  = edge2x7."2"  AND edge2x5."5"  = edge5x10."5" ) 
ON edge1x10."1"  = edge1x2."1"  AND edge1x10."10"  = edge5x10."10" ) 
ON edge3x9."3"  = edge1x3."3"  AND edge3x9."9"  = edge0x9."9" ) 
ON edge0x12."0"  = edge0x9."0"  AND edge0x12."12"  = edge4x12."12" ) 
ON edge3x8."3"  = edge1x3."3"  AND edge3x8."8"  = edge4x8."8" ) 
ON edge1x8."1"  = edge1x2."1"  AND edge1x8."8"  = edge4x8."8" ) 
ON edge8x11."8"  = edge4x8."8"  AND edge8x11."11"  = edge6x11."11" ) 
ON edge0x11."0"  = edge0x9."0"  AND edge0x11."11"  = edge6x11."11" ) 
ON edge0x1."0"  = edge0x9."0"  AND edge0x1."1"  = edge1x2."1" ) 
ON edge7x8."7"  = edge2x7."7"  AND edge7x8."8"  = edge4x8."8" ) 
ON edge0x3."0"  = edge0x9."0"  AND edge0x3."3"  = edge1x3."3" ) 
ON edge8x9."8"  = edge4x8."8"  AND edge8x9."9"  = edge0x9."9" ) 
ON edge3x7."3"  = edge1x3."3"  AND edge3x7."7"  = edge2x7."7" ) 
ON edge1x9."1"  = edge1x2."1"  AND edge1x9."9"  = edge0x9."9" ) 
WHERE (1=1)
