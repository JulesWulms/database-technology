...
ON edge11x12."11"  = edge5x11."11"  AND edge11x12."12"  = edge0x12."12" ) 
ON edge7x12."7"  = edge7x8."7"  AND edge7x12."12"  = edge0x12."12" ) 
ON edge0x13."0"  = edge0x12."0"  AND edge0x13."13"  = edge10x13."13" ) 
ON edge6x7."6"  = edge0x6."6"  AND edge6x7."7"  = edge7x8."7" ) 
ON edge1x2."1"  = edge1x9."1"  AND edge1x2."2"  = edge2x5."2" ) 
ON edge8x12."8"  = edge7x8."8"  AND edge8x12."12"  = edge0x12."12" ) 
ON edge2x9."2"  = edge2x5."2"  AND edge2x9."9"  = edge1x9."9" ) 
ON edge2x12."2"  = edge2x5."2"  AND edge2x12."12"  = edge0x12."12" ) 
ON edge4x10."4"  = edge1x4."4"  AND edge4x10."10"  = edge10x13."10" ) 
ON edge1x7."1"  = edge1x9."1"  AND edge1x7."7"  = edge7x8."7" ) 
ON edge0x3."0"  = edge0x12."0"  AND edge0x3."3"  = edge3x5."3" ) 
ON edge7x13."7"  = edge7x8."7"  AND edge7x13."13"  = edge10x13."13" ) 
ON edge11x13."11"  = edge5x11."11"  AND edge11x13."13"  = edge10x13."13" ) 
WHERE (1=1)
