...
FROM 
( edge5x9 JOIN 
( SELECT edgeP2."0", edgeP2."5", edgeP2."9"
FROM 
( edge1x10 JOIN 
( SELECT edgeP4."0", edgeP4."1", edgeP4."5", edgeP4."9", edgeP4."10"
FROM 
( edge1x2 JOIN 
( SELECT edgeP11."0", edgeP11."1", edgeP11."2", edgeP11."5", edgeP11."9", edgeP11."10"
FROM 
( edge4x5 JOIN 
( SELECT edgeP6."0", edgeP6."1", edgeP6."2", edgeP6."4", edgeP6."5", edgeP6."9", edgeP6."10"
FROM 
( edge7x11 JOIN 
( edge0x10 JOIN 
( edge2x10 JOIN 
( edge0x4 JOIN 
( SELECT edgeP3."0", edgeP3."1", edgeP3."2", edgeP3."4", edgeP3."5", edgeP3."7", edgeP3."9", edgeP3."10", edgeP3."11"
FROM 
( edge5x6 JOIN 
( SELECT edgeP8."0", edgeP8."1", edgeP8."2", edgeP8."4", edgeP8."5", edgeP8."6", edgeP8."7", edgeP8."9", edgeP8."10", edgeP8."11"
FROM 
( edge3x6 JOIN 
( SELECT edge0x7."0", edge1x5."1", edge2x8."2", edge3x7."3", edge4x10."4", edge0x5."5", edge6x11."6", edge0x7."7", edge7x9."9", edge4x10."10", edge6x11."11"
FROM 
( edge8x9 JOIN 
( edge4x11 JOIN 
( edge7x10 JOIN 
...
ON edge1x5."1"  = edge1x5."1"  AND edge1x5."5"  = edge0x5."5" ) 
ON edge1x6."1"  = edge1x5."1"  AND edge1x6."6"  = edge6x11."6" ) 
ON edge8x10."8"  = edge2x8."8"  AND edge8x10."10"  = edge4x10."10" ) 
...
ON edge6x10."6"  = edge6x11."6"  AND edge6x10."10"  = edge4x10."10" ) 
ON edge10x11."10"  = edge4x10."10"  AND edge10x11."11"  = edge6x11."11" ) 
ON edge7x8."7"  = edge0x7."7"  AND edge7x8."8"  = edge2x8."8" ) 
ON edge6x9."6"  = edge6x11."6"  AND edge6x9."9"  = edge7x9."9" ) 
ON edge1x3."1"  = edge1x5."1"  AND edge1x3."3"  = edge3x7."3" ) 
ON edge7x10."7"  = edge0x7."7"  AND edge7x10."10"  = edge4x10."10" ) 
ON edge4x11."4"  = edge4x10."4"  AND edge4x11."11"  = edge6x11."11" ) 
...
ON edge7x11."7"  = edgeP6."7"  AND edge7x11."11"  = edgeP6."11" ) 
