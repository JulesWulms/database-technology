...
FROM 
( edge1x19 JOIN 
( SELECT edgeP15."1", edgeP15."2", edgeP15."19"
FROM 
( edge0x7 JOIN 
( SELECT edgeP14."0", edgeP14."1", edgeP14."2", edgeP14."7", edgeP14."19"
FROM 
( edge11x15 JOIN 
( SELECT edgeP8."0", edgeP8."1", edgeP8."2", edgeP8."7", edgeP8."11", edgeP8."15", edgeP8."19"
FROM 
( edge9x14 JOIN 
( SELECT edgeP17."0", edgeP17."1", edgeP17."2", edgeP17."7", edgeP17."9", edgeP17."11", edgeP17."14", edgeP17."15", edgeP17."19"
FROM 
( edge8x19 JOIN 
( SELECT edgeP6."0", edgeP6."1", edgeP6."2", edgeP6."7", edgeP6."8", edgeP6."9", edgeP6."11", edgeP6."14", edgeP6."15", edgeP6."19"
FROM 
( edge10x17 JOIN 
( edge2x7 JOIN 
( SELECT edgeP12."0", edgeP12."1", edgeP12."2", edgeP12."7", edgeP12."8", edgeP12."9", edgeP12."10", edgeP12."11", edgeP12."14", edgeP12."15", edgeP12."17", edgeP12."19"
FROM 
( edge3x6 JOIN 
( SELECT edgeP4."0", edgeP4."1", edgeP4."2", edgeP4."3", edgeP4."6", edgeP4."7", edgeP4."8", edgeP4."9", edgeP4."10", edgeP4."11", edgeP4."14", edgeP4."15", edgeP4."17", edgeP4."19"
FROM 
( edge0x12 JOIN 
( edge3x9 JOIN 
( SELECT edgeP13."0", edgeP13."1", edgeP13."2", edgeP13."3", edgeP13."6", edgeP13."7", edgeP13."8", edgeP13."9", edgeP13."10", edgeP13."11", edgeP13."12", edgeP13."14", edgeP13."15", edgeP13."17", edgeP13."19"
FROM 
( edge4x9 JOIN 
( edge1x4 JOIN 
( edge2x19 JOIN 
( SELECT edgeP16."0", edgeP16."1", edgeP16."2", edgeP16."3", edgeP16."4", edgeP16."6", edgeP16."7", edgeP16."8", edgeP16."9", edgeP16."10", edgeP16."11", edgeP16."12", edgeP16."14", edgeP16."15", edgeP16."17", edgeP16."19"
FROM 
( edge5x13 JOIN 
( edge2x17 JOIN 
( edge1x6 JOIN 
( edge1x8 JOIN 
( edge4x17 JOIN 
( SELECT edgeP18."0", edgeP18."1", edgeP18."2", edgeP18."3", edgeP18."4", edgeP18."5", edgeP18."6", edgeP18."7", edgeP18."8", edgeP18."9", edgeP18."10", edgeP18."11", edgeP18."12", edgeP18."13", edgeP18."14", edgeP18."15", edgeP18."17", edgeP18."19"
FROM 
( edge16x17 JOIN 
( edge5x17 JOIN 
( edge6x15 JOIN 
...
( edge2x14 JOIN 
( edge5x15 JOIN 
( SELECT edge0x1."0", edge0x1."1", edge2x4."2", edge0x3."3", edge2x4."4", edge2x5."5", edge6x9."6", edge7x9."7", edge3x8."8", edge2x9."9", edge5x10."10", edge11x14."11", edge12x19."12", edge13x17."13", edge12x14."14", edge15x19."15", edge17x19."17", edge16x19."16", edge17x19."19"
FROM 
( edge4x18 JOIN 
( edge3x15 JOIN 
( edge0x4 JOIN 
...
ON edge5x15."5"  = edgeP18."5"  AND edge5x15."15"  = edgeP18."15" ) 
ON edge2x14."2"  = edgeP18."2"  AND edge2x14."14"  = edgeP18."14" ) 
ON edge7x11."7"  = edgeP18."7"  AND edge7x11."11"  = edgeP18."11" ) 
ON edge0x11."0"  = edgeP18."0"  AND edge0x11."11"  = edgeP18."11" ) 
ON edge4x6."4"  = edgeP18."4"  AND edge4x6."6"  = edgeP18."6" ) 
ON edge6x15."6"  = edgeP18."6"  AND edge6x15."15"  = edgeP18."15" ) 
...
ON edge1x8."1"  = edgeP16."1"  AND edge1x8."8"  = edgeP16."8" ) 
ON edge1x6."1"  = edgeP16."1"  AND edge1x6."6"  = edgeP16."6" ) 
ON edge2x17."2"  = edgeP16."2"  AND edge2x17."17"  = edgeP16."17" ) 
ON edge5x13."5"  = edgeP16."5"  AND edge5x13."13"  = edgeP16."13" ) 
WHERE (1=1) ) AS edgeP13
ON edge2x19."2"  = edgeP13."2"  AND edge2x19."19"  = edgeP13."19" ) 
...
WHERE (1=1) ) AS edgeP6
ON edge2x7."2"  = edgeP6."2"  AND edge2x7."7"  = edgeP6."7" ) 
...
WHERE (1=1) ) AS edgeP8
ON edge9x14."9"  = edgeP8."9"  AND edge9x14."14"  = edgeP8."14" ) 
