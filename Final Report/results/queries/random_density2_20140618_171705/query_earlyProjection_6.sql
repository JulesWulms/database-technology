...
FROM 
( edge5x11 JOIN 
( SELECT edgeP1."5", edgeP1."9", edgeP1."11"
FROM 
( edge10x14 JOIN 
( SELECT edgeP2."5", edgeP2."9", edgeP2."10", edgeP2."11", edgeP2."14"
FROM 
( edge1x10 JOIN 
( SELECT edgeP15."1", edgeP15."5", edgeP15."9", edgeP15."10", edgeP15."11", edgeP15."14"
FROM 
( edge1x2 JOIN 
( SELECT edgeP8."1", edgeP8."2", edgeP8."5", edgeP8."9", edgeP8."10", edgeP8."11", edgeP8."14"
FROM 
( edge14x15 JOIN 
( SELECT edgeP0."1", edgeP0."2", edgeP0."5", edgeP0."9", edgeP0."10", edgeP0."11", edgeP0."14", edgeP0."15"
FROM 
( edge8x10 JOIN 
( edge2x14 JOIN 
( SELECT edgeP13."1", edgeP13."2", edgeP13."5", edgeP13."8", edgeP13."9", edgeP13."10", edgeP13."11", edgeP13."14", edgeP13."15"
FROM 
( edge0x8 JOIN 
( SELECT edgeP4."0", edgeP4."1", edgeP4."2", edgeP4."5", edgeP4."8", edgeP4."9", edgeP4."10", edgeP4."11", edgeP4."14", edgeP4."15"
FROM 
( edge10x13 JOIN 
( edge0x2 JOIN 
( edge1x13 JOIN 
...
( edge8x13 JOIN 
( edge4x9 JOIN 
( SELECT edgeP6."0", edgeP6."1", edgeP6."2", edgeP6."3", edgeP6."4", edgeP6."5", edgeP6."8", edgeP6."9", edgeP6."10", edgeP6."11", edgeP6."12", edgeP6."13", edgeP6."14", edgeP6."15"
FROM 
( edge3x7 JOIN 
( SELECT edge0x13."0", edge1x6."1", edge2x13."2", edge3x8."3", edge4x13."4", edge5x14."5", edge2x7."7", edge3x8."8", edge9x13."9", edge4x10."10", edge11x15."11", edge3x12."12", edge9x13."13", edge5x14."14", edge11x15."15"
FROM 
( edge6x15 JOIN 
( edge4x10 JOIN 
( edge8x9 JOIN 
...
ON edge1x14."1"  = edge1x6."1"  AND edge1x14."14"  = edge5x14."14" ) 
ON edge12x14."12"  = edge3x12."12"  AND edge12x14."14"  = edge5x14."14" ) 
ON edge1x3."1"  = edge1x6."1"  AND edge1x3."3"  = edge3x8."3" ) 
ON edge11x13."11"  = edge11x15."11"  AND edge11x13."13"  = edge9x13."13" ) 
ON edge9x12."9"  = edge9x13."9"  AND edge9x12."12"  = edge3x12."12" ) 
ON edge1x9."1"  = edge1x6."1"  AND edge1x9."9"  = edge9x13."9" ) 
ON edge2x7."2"  = edge2x13."2"  AND edge2x7."7"  = edge2x7."7" ) 
ON edge3x5."3"  = edge3x8."3"  AND edge3x5."5"  = edge5x14."5" ) 
ON edge8x9."8"  = edge3x8."8"  AND edge8x9."9"  = edge9x13."9" ) 
ON edge4x10."4"  = edge4x13."4"  AND edge4x10."10"  = edge4x10."10" ) 
ON edge6x15."6"  = edge1x6."6"  AND edge6x15."15"  = edge11x15."15" ) 
WHERE (1=1) ) AS edgeP6
ON edge3x7."3"  = edgeP6."3"  AND edge3x7."7"  = edgeP6."7" ) 
WHERE (1=1) ) AS edgeP7
...
ON edge10x13."10"  = edgeP4."10"  AND edge10x13."13"  = edgeP4."13" ) 
