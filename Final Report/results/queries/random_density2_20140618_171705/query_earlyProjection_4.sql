...
FROM 
( edge0x12 JOIN 
( SELECT edgeP7."0", edgeP7."3", edgeP7."12"
FROM 
( edge4x6 JOIN 
( SELECT edgeP13."0", edgeP13."3", edgeP13."4", edgeP13."6", edgeP13."12"
FROM 
( edge7x12 JOIN 
( SELECT edgeP5."0", edgeP5."3", edgeP5."4", edgeP5."6", edgeP5."7", edgeP5."12"
FROM 
( edge0x13 JOIN 
( SELECT edgeP11."0", edgeP11."3", edgeP11."4", edgeP11."6", edgeP11."7", edgeP11."12", edgeP11."13"
FROM 
( edge4x5 JOIN 
( edge5x6 JOIN 
( SELECT edgeP8."0", edgeP8."3", edgeP8."4", edgeP8."5", edgeP8."6", edgeP8."7", edgeP8."12", edgeP8."13"
FROM 
( edge0x11 JOIN 
( edge3x6 JOIN 
( edge11x13 JOIN 
( SELECT edgeP9."0", edgeP9."3", edgeP9."4", edgeP9."5", edgeP9."6", edgeP9."7", edgeP9."11", edgeP9."12", edgeP9."13"
FROM 
( edge0x8 JOIN 
( SELECT edgeP2."0", edgeP2."3", edgeP2."4", edgeP2."5", edgeP2."6", edgeP2."7", edgeP2."8", edgeP2."11", edgeP2."12", edgeP2."13"
FROM 
( edge1x9 JOIN 
( SELECT edgeP10."0", edgeP10."1", edgeP10."3", edgeP10."4", edgeP10."5", edgeP10."6", edgeP10."7", edgeP10."8", edgeP10."9", edgeP10."11", edgeP10."12", edgeP10."13"
FROM 
( edge2x7 JOIN 
( edge1x6 JOIN 
( edge5x9 JOIN 
( edge2x4 JOIN 
( SELECT edge0x10."0", edge1x12."1", edge2x12."2", edge3x5."3", edge4x10."4", edge3x5."5", edge6x10."6", edge7x8."7", edge8x10."8", edge8x9."9", edge8x11."11", edge3x12."12", edge4x13."13"
FROM 
( edge7x10 JOIN 
( edge1x5 JOIN 
( edge8x13 JOIN 
...
ON edge6x10."6"  = edge6x10."6"  AND edge6x10."10"  = edge4x10."10" ) 
...
ON edge9x11."9"  = edge8x9."9"  AND edge9x11."11"  = edge8x11."11" ) 
ON edge11x12."11"  = edge8x11."11"  AND edge11x12."12"  = edge3x12."12" ) 
ON edge8x13."8"  = edge8x10."8"  AND edge8x13."13"  = edge4x13."13" ) 
ON edge1x5."1"  = edge1x12."1"  AND edge1x5."5"  = edge3x5."5" ) 
