...
FROM 
( edge3x5 JOIN 
( SELECT edgeP6."0", edgeP6."3", edgeP6."4", edgeP6."5"
FROM 
( edge2x3 JOIN 
( SELECT edgeP7."0", edgeP7."2", edgeP7."3", edgeP7."4", edgeP7."5"
FROM 
( edge4x6 JOIN 
( SELECT edgeP9."0", edgeP9."2", edgeP9."3", edgeP9."4", edgeP9."5", edgeP9."6"
FROM 
( edge6x7 JOIN 
( SELECT edgeP8."0", edgeP8."2", edgeP8."3", edgeP8."4", edgeP8."5", edgeP8."6", edgeP8."7"
FROM 
( edge4x9 JOIN 
( edge0x2 JOIN 
( edge2x6 JOIN 
( edge2x5 JOIN 
( SELECT edgeP1."0", edgeP1."2", edgeP1."3", edgeP1."4", edgeP1."5", edgeP1."6", edgeP1."7", edgeP1."9"
FROM 
( edge4x8 JOIN 
( edge3x4 JOIN 
( edge0x4 JOIN 
( SELECT edge0x8."0", edge2x8."2", edge3x9."3", edge2x4."4", edge0x5."5", edge6x9."6", edge1x7."7", edge0x8."8", edge0x9."9"
FROM 
( edge1x3 JOIN 
( edge0x7 JOIN 
( edge3x8 JOIN 
...
ON edge1x2."1"  = edge1x7."1"  AND edge1x2."2"  = edge2x8."2" ) 
ON edge1x8."1"  = edge1x7."1"  AND edge1x8."8"  = edge0x8."8" ) 
ON edge2x4."2"  = edge2x8."2"  AND edge2x4."4"  = edge2x4."4" ) 
ON edge0x6."0"  = edge0x8."0"  AND edge0x6."6"  = edge6x9."6" ) 
ON edge0x3."0"  = edge0x8."0"  AND edge0x3."3"  = edge3x9."3" ) 
ON edge3x8."3"  = edge3x9."3"  AND edge3x8."8"  = edge0x8."8" ) 
ON edge0x7."0"  = edge0x8."0"  AND edge0x7."7"  = edge1x7."7" ) 
...
ON edge4x8."4"  = edgeP1."4"  AND edge4x8."8"  = edgeP1."8" ) 
WHERE (1=1) ) AS edgeP8
...
WHERE (1=1) ) AS edgeP2
ON edge3x5."3"  = edgeP2."3"  AND edge3x5."5"  = edgeP2."5" ) 
WHERE (1=1) ) AS edgeP3
