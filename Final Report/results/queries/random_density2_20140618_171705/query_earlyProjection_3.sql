...
FROM 
( edge1x11 JOIN 
( SELECT edgeP8."1", edgeP8."5", edgeP8."11"
FROM 
( edge2x3 JOIN 
( SELECT edgeP4."1", edgeP4."2", edgeP4."3", edgeP4."5", edgeP4."11"
FROM 
( edge6x8 JOIN 
( SELECT edgeP0."1", edgeP0."2", edgeP0."3", edgeP0."5", edgeP0."6", edgeP0."8", edgeP0."11"
FROM 
( edge4x5 JOIN 
( SELECT edgeP7."1", edgeP7."2", edgeP7."3", edgeP7."4", edgeP7."5", edgeP7."6", edgeP7."8", edgeP7."11"
FROM 
( edge0x3 JOIN 
( SELECT edgeP10."0", edgeP10."1", edgeP10."2", edgeP10."3", edgeP10."4", edgeP10."5", edgeP10."6", edgeP10."8", edgeP10."11"
FROM 
( edge5x7 JOIN 
( edge2x4 JOIN 
( SELECT edgeP12."0", edgeP12."1", edgeP12."2", edgeP12."3", edgeP12."4", edgeP12."5", edgeP12."6", edgeP12."7", edgeP12."8", edgeP12."11"
FROM 
( edge1x10 JOIN 
( edge3x10 JOIN 
( SELECT edgeP9."0", edgeP9."1", edgeP9."2", edgeP9."3", edgeP9."4", edgeP9."5", edgeP9."6", edgeP9."7", edgeP9."8", edgeP9."10", edgeP9."11"
FROM 
( edge8x12 JOIN 
( edge0x4 JOIN 
( edge1x7 JOIN 
...
ON edge4x8."4"  = edge4x9."4"  AND edge4x8."8"  = edge3x8."8" ) 
ON edge0x1."0"  = edge0x11."0"  AND edge0x1."1"  = edge1x6."1" ) 
ON edge5x6."5"  = edge5x10."5"  AND edge5x6."6"  = edge1x6."6" ) 
