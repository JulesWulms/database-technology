...
ON edge8x18."8"  = edge8x15."8"  AND edge8x18."18"  = edge4x18."18" ) 
ON edge0x15."0"  = edge0x18."0"  AND edge0x15."15"  = edge8x15."15" ) 
ON edge1x16."1"  = edge1x12."1"  AND edge1x16."16"  = edge14x16."16" ) 
ON edge8x13."8"  = edge8x15."8"  AND edge8x13."13"  = edge13x15."13" ) 
ON edge16x17."16"  = edge14x16."16"  AND edge16x17."17"  = edge7x17."17" ) 
ON edge17x19."17"  = edge7x17."17"  AND edge17x19."19"  = edge2x19."19" ) 
ON edge16x19."16"  = edge14x16."16"  AND edge16x19."19"  = edge2x19."19" ) 
ON edge3x8."3"  = edge3x18."3"  AND edge3x8."8"  = edge8x15."8" ) 
ON edge15x19."15"  = edge8x15."15"  AND edge15x19."19"  = edge2x19."19" ) 
ON edge5x14."5"  = edge5x15."5"  AND edge5x14."14"  = edge2x14."14" ) 
ON edge0x9."0"  = edge0x18."0"  AND edge0x9."9"  = edge9x13."9" ) 
ON edge7x13."7"  = edge7x17."7"  AND edge7x13."13"  = edge13x15."13" ) 
ON edge1x10."1"  = edge1x12."1"  AND edge1x10."10"  = edge10x11."10" ) 
ON edge1x13."1"  = edge1x12."1"  AND edge1x13."13"  = edge13x15."13" ) 
ON edge2x12."2"  = edge2x14."2"  AND edge2x12."12"  = edge12x15."12" ) 
ON edge12x13."12"  = edge12x15."12"  AND edge12x13."13"  = edge13x15."13" ) 
WHERE (1=1)
