...
FROM 
( edge12x13 JOIN 
( SELECT edgeP1."4", edgeP1."12", edgeP1."13"
FROM 
( edge2x12 JOIN 
( SELECT edgeP10."2", edgeP10."4", edgeP10."12", edgeP10."13"
FROM 
( edge1x13 JOIN 
( SELECT edgeP7."1", edgeP7."2", edgeP7."4", edgeP7."12", edgeP7."13"
FROM 
( edge1x10 JOIN 
( SELECT edgeP9."1", edgeP9."2", edgeP9."4", edgeP9."10", edgeP9."12", edgeP9."13"
FROM 
( edge7x13 JOIN 
( SELECT edgeP14."1", edgeP14."2", edgeP14."4", edgeP14."7", edgeP14."10", edgeP14."12", edgeP14."13"
FROM 
( edge0x9 JOIN 
( SELECT edgeP19."0", edgeP19."1", edgeP19."2", edgeP19."4", edgeP19."7", edgeP19."9", edgeP19."10", edgeP19."12", edgeP19."13"
FROM 
( edge5x14 JOIN 
( SELECT edgeP8."0", edgeP8."1", edgeP8."2", edgeP8."4", edgeP8."5", edgeP8."7", edgeP8."9", edgeP8."10", edgeP8."12", edgeP8."13", edgeP8."14"
FROM 
( edge15x19 JOIN 
( SELECT edgeP16."0", edgeP16."1", edgeP16."2", edgeP16."4", edgeP16."5", edgeP16."7", edgeP16."9", edgeP16."10", edgeP16."12", edgeP16."13", edgeP16."14", edgeP16."15", edgeP16."19"
FROM 
( edge3x8 JOIN 
( SELECT edgeP17."0", edgeP17."1", edgeP17."2", edgeP17."3", edgeP17."4", edgeP17."5", edgeP17."7", edgeP17."8", edgeP17."9", edgeP17."10", edgeP17."12", edgeP17."13", edgeP17."14", edgeP17."15", edgeP17."19"
FROM 
( edge16x19 JOIN 
( SELECT edgeP18."0", edgeP18."1", edgeP18."2", edgeP18."3", edgeP18."4", edgeP18."5", edgeP18."7", edgeP18."8", edgeP18."9", edgeP18."10", edgeP18."12", edgeP18."13", edgeP18."14", edgeP18."15", edgeP18."16", edgeP18."19"
FROM 
( edge17x19 JOIN 
( edge16x17 JOIN 
( edge8x13 JOIN 
( edge1x16 JOIN 
( edge0x15 JOIN 
( SELECT edgeP11."0", edgeP11."1", edgeP11."2", edgeP11."3", edgeP11."4", edgeP11."5", edgeP11."7", edgeP11."8", edgeP11."9", edgeP11."10", edgeP11."12", edgeP11."13", edgeP11."14", edgeP11."15", edgeP11."17", edgeP11."16", edgeP11."19"
FROM 
( edge8x18 JOIN 
( SELECT edge0x18."0", edge1x12."1", edge2x14."2", edge3x18."3", edge4x18."4", edge5x15."5", edge7x17."7", edge8x15."8", edge9x13."9", edge10x11."10", edge12x15."12", edge13x15."13", edge2x14."14", edge8x15."15", edge7x17."17", edge14x16."16", edge2x19."19", edge4x18."18"
FROM 
( edge6x11 JOIN 
( edge4x14 JOIN 
( edge11x14 JOIN 
...
ON edge8x19."8"  = edge8x15."8"  AND edge8x19."19"  = edge2x19."19" ) 
ON edge11x19."11"  = edge10x11."11"  AND edge11x19."19"  = edge2x19."19" ) 
ON edge1x7."1"  = edge1x12."1"  AND edge1x7."7"  = edge7x17."7" ) 
ON edge0x3."0"  = edge0x18."0"  AND edge0x3."3"  = edge3x18."3" ) 
ON edge2x6."2"  = edge2x14."2"  AND edge2x6."6"  = edge6x7."6" ) 
ON edge6x16."6"  = edge6x7."6"  AND edge6x16."16"  = edge14x16."16" ) 
ON edge10x16."10"  = edge10x11."10"  AND edge10x16."16"  = edge14x16."16" ) 
ON edge13x16."13"  = edge13x15."13"  AND edge13x16."16"  = edge14x16."16" ) 
ON edge7x10."7"  = edge7x17."7"  AND edge7x10."10"  = edge10x11."10" ) 
ON edge8x14."8"  = edge8x15."8"  AND edge8x14."14"  = edge2x14."14" ) 
ON edge8x12."8"  = edge8x15."8"  AND edge8x12."12"  = edge12x15."12" ) 
ON edge11x17."11"  = edge10x11."11"  AND edge11x17."17"  = edge7x17."17" ) 
ON edge1x14."1"  = edge1x12."1"  AND edge1x14."14"  = edge2x14."14" ) 
ON edge9x15."9"  = edge9x13."9"  AND edge9x15."15"  = edge8x15."15" ) 
ON edge3x4."3"  = edge3x18."3"  AND edge3x4."4"  = edge4x18."4" ) 
ON edge7x18."7"  = edge7x17."7"  AND edge7x18."18"  = edge4x18."18" ) 
ON edge11x14."11"  = edge10x11."11"  AND edge11x14."14"  = edge2x14."14" ) 
ON edge4x14."4"  = edge4x18."4"  AND edge4x14."14"  = edge2x14."14" ) 
ON edge6x11."6"  = edge6x7."6"  AND edge6x11."11"  = edge10x11."11" ) 
...
ON edge1x16."1"  = edgeP18."1"  AND edge1x16."16"  = edgeP18."16" ) 
ON edge8x13."8"  = edgeP18."8"  AND edge8x13."13"  = edgeP18."13" ) 
ON edge16x17."16"  = edgeP18."16"  AND edge16x17."17"  = edgeP18."17" ) 
ON edge17x19."17"  = edgeP18."17"  AND edge17x19."19"  = edgeP18."19" ) 
WHERE (1=1) ) AS edgeP17
ON edge16x19."16"  = edgeP17."16"  AND edge16x19."19"  = edgeP17."19" ) 
WHERE (1=1) ) AS edgeP16
ON edge3x8."3"  = edgeP16."3"  AND edge3x8."8"  = edgeP16."8" ) 
WHERE (1=1) ) AS edgeP8
ON edge15x19."15"  = edgeP8."15"  AND edge15x19."19"  = edgeP8."19" ) 
WHERE (1=1) ) AS edgeP19
ON edge5x14."5"  = edgeP19."5"  AND edge5x14."14"  = edgeP19."14" ) 
WHERE (1=1) ) AS edgeP14
ON edge0x9."0"  = edgeP14."0"  AND edge0x9."9"  = edgeP14."9" ) 
WHERE (1=1) ) AS edgeP9
ON edge7x13."7"  = edgeP9."7"  AND edge7x13."13"  = edgeP9."13" ) 
WHERE (1=1) ) AS edgeP7
...
WHERE (1=1) ) AS edgeP2
ON edge12x13."12"  = edgeP2."12"  AND edge12x13."13"  = edgeP2."13" ) 
