...
FROM 
( edge5x6 JOIN 
( SELECT edgeP1."3", edgeP1."4", edgeP1."5", edgeP1."6", edgeP1."7"
FROM 
( edge2x6 JOIN 
( SELECT edgeP9."2", edgeP9."3", edgeP9."4", edgeP9."5", edgeP9."6", edgeP9."7"
FROM 
( edge0x1 JOIN 
( edge0x6 JOIN 
( edge1x4 JOIN 
( SELECT edge0x9."0", edge1x7."1", edge2x3."2", edge3x9."3", edge4x6."4", edge5x8."5", edge4x6."6", edge0x7."7"
FROM 
( edge8x9 JOIN 
( edge1x9 JOIN 
( edge2x9 JOIN 
...
WHERE (1=1) ) AS edgeP1
ON edge2x6."2"  = edgeP1."2"  AND edge2x6."6"  = edgeP1."6" ) 
WHERE (1=1) ) AS edgeP2
