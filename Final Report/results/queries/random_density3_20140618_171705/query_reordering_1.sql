...
FROM 
( edge5x9 JOIN 
( SELECT edgeP3."5", edgeP3."9"
FROM 
( edge6x9 JOIN 
( SELECT edgeP10."5", edgeP10."6", edgeP10."9"
FROM 
( edge3x9 JOIN 
( SELECT edgeP7."3", edgeP7."5", edgeP7."6", edgeP7."9"
FROM 
( edge4x10 JOIN 
( SELECT edgeP0."3", edgeP0."4", edgeP0."5", edgeP0."6", edgeP0."9", edgeP0."10"
FROM 
( edge7x10 JOIN 
( edge5x7 JOIN 
( SELECT edgeP1."3", edgeP1."4", edgeP1."5", edgeP1."6", edgeP1."7", edgeP1."9", edgeP1."10"
FROM 
( edge0x7 JOIN 
( edge4x5 JOIN 
( edge3x7 JOIN 
( edge0x6 JOIN 
( edge5x10 JOIN 
( SELECT edgeP2."0", edgeP2."3", edgeP2."4", edgeP2."5", edgeP2."6", edgeP2."7", edgeP2."9", edgeP2."10"
FROM 
( edge1x7 JOIN 
( edge0x1 JOIN 
( edge6x7 JOIN 
( SELECT edgeP8."0", edgeP8."1", edgeP8."3", edgeP8."4", edgeP8."5", edgeP8."6", edgeP8."7", edgeP8."9", edgeP8."10"
FROM 
( edge2x4 JOIN 
( edge0x2 JOIN 
( edge7x9 JOIN 
...
( edge0x9 JOIN 
( edge1x10 JOIN 
( SELECT edge0x10."0", edge1x5."1", edge2x7."2", edge3x4."3", edge1x4."4", edge5x6."5", edge5x6."6", edge2x7."7", edge1x9."9", edge6x10."10"
FROM 
( edge6x8 JOIN 
( edge3x8 JOIN 
( edge9x10 JOIN 
...
ON edge6x8."6"  = edge5x6."6"  AND edge6x8."8"  = edge2x8."8" ) 
WHERE (1=1) ) AS edgeP8
ON edge1x10."1"  = edgeP8."1"  AND edge1x10."10"  = edgeP8."10" ) 
ON edge0x9."0"  = edgeP8."0"  AND edge0x9."9"  = edgeP8."9" ) 
ON edge3x10."3"  = edgeP8."3"  AND edge3x10."10"  = edgeP8."10" ) 
