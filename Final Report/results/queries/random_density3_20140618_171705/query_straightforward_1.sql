...
ON edge7x10."7"  = edge2x7."7"  AND edge7x10."10"  = edge6x10."10" ) 
ON edge0x6."0"  = edge0x10."0"  AND edge0x6."6"  = edge5x6."6" ) 
ON edge6x8."6"  = edge5x6."6"  AND edge6x8."8"  = edge2x8."8" ) 
ON edge4x5."4"  = edge1x4."4"  AND edge4x5."5"  = edge5x6."5" ) 
ON edge0x7."0"  = edge0x10."0"  AND edge0x7."7"  = edge2x7."7" ) 
ON edge5x7."5"  = edge5x6."5"  AND edge5x7."7"  = edge2x7."7" ) 
ON edge1x7."1"  = edge1x5."1"  AND edge1x7."7"  = edge2x7."7" ) 
ON edge5x9."5"  = edge5x6."5"  AND edge5x9."9"  = edge1x9."9" ) 
ON edge6x7."6"  = edge5x6."6"  AND edge6x7."7"  = edge2x7."7" ) 
ON edge6x9."6"  = edge5x6."6"  AND edge6x9."9"  = edge1x9."9" ) 
