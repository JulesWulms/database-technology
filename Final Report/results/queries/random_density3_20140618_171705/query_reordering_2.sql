...
FROM 
( edge0x2 JOIN 
( SELECT edgeP6."0", edgeP6."2"
FROM 
( edge0x4 JOIN 
( SELECT edgeP10."0", edgeP10."2", edgeP10."4"
FROM 
( edge2x6 JOIN 
( SELECT edgeP7."0", edgeP7."2", edgeP7."4", edgeP7."6"
FROM 
( edge9x10 JOIN 
( edge6x9 JOIN 
( SELECT edgeP1."0", edgeP1."2", edgeP1."4", edgeP1."6", edgeP1."9", edgeP1."10"
FROM 
( edge3x7 JOIN 
( SELECT edgeP5."0", edgeP5."2", edgeP5."3", edgeP5."4", edgeP5."6", edgeP5."7", edgeP5."9", edgeP5."10"
FROM 
( edge1x3 JOIN 
( SELECT edgeP11."0", edgeP11."1", edgeP11."2", edgeP11."3", edgeP11."4", edgeP11."6", edgeP11."7", edgeP11."9", edgeP11."10"
FROM 
( edge2x5 JOIN 
