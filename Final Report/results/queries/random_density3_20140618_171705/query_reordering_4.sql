...
FROM 
( edge2x4 JOIN 
( SELECT edgeP13."2", edgeP13."4", edgeP13."8"
FROM 
( edge1x4 JOIN 
( SELECT edgeP7."1", edgeP7."2", edgeP7."4", edgeP7."8"
FROM 
( edge12x13 JOIN 
( SELECT edgeP5."1", edgeP5."2", edgeP5."4", edgeP5."8", edgeP5."12", edgeP5."13"
FROM 
( edge1x7 JOIN 
( edge7x13 JOIN 
( SELECT edgeP3."1", edgeP3."2", edgeP3."4", edgeP3."7", edgeP3."8", edgeP3."12", edgeP3."13"
FROM 
( edge4x5 JOIN 
( SELECT edgeP6."1", edgeP6."2", edgeP6."4", edgeP6."5", edgeP6."7", edgeP6."8", edgeP6."12", edgeP6."13"
FROM 
( edge2x3 JOIN 
( edge8x12 JOIN 
( edge3x7 JOIN 
( edge5x8 JOIN 
( edge1x8 JOIN 
( SELECT edgeP10."1", edgeP10."2", edgeP10."3", edgeP10."4", edgeP10."5", edgeP10."7", edgeP10."8", edgeP10."12", edgeP10."13"
FROM 
( edge6x8 JOIN 
( SELECT edgeP11."1", edgeP11."2", edgeP11."3", edgeP11."4", edgeP11."5", edgeP11."6", edgeP11."7", edgeP11."8", edgeP11."12", edgeP11."13"
FROM 
( edge6x10 JOIN 
( SELECT edgeP0."1", edgeP0."2", edgeP0."3", edgeP0."4", edgeP0."5", edgeP0."6", edgeP0."7", edgeP0."8", edgeP0."10", edgeP0."12", edgeP0."13"
FROM 
( edge10x11 JOIN 
( edge5x11 JOIN 
( edge4x11 JOIN 
( SELECT edgeP9."1", edgeP9."2", edgeP9."3", edgeP9."4", edgeP9."5", edgeP9."6", edgeP9."7", edgeP9."8", edgeP9."10", edgeP9."11", edgeP9."12", edgeP9."13"
FROM 
( edge0x11 JOIN 
( edge0x5 JOIN 
( edge3x12 JOIN 
...
ON edge0x11."0"  = edgeP9."0"  AND edge0x11."11"  = edgeP9."11" ) 
WHERE (1=1) ) AS edgeP0
...
ON edge2x3."2"  = edgeP6."2"  AND edge2x3."3"  = edgeP6."3" ) 
WHERE (1=1) ) AS edgeP3
...
WHERE (1=1) ) AS edgeP7
ON edge12x13."12"  = edgeP7."12"  AND edge12x13."13"  = edgeP7."13" ) 
