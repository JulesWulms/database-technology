...
FROM 
( edge6x8 JOIN 
( SELECT edgeP0."5", edgeP0."6", edgeP0."7", edgeP0."8"
FROM 
( edge7x10 JOIN 
( SELECT edgeP11."5", edgeP11."6", edgeP11."7", edgeP11."8", edgeP11."10"
FROM 
( edge0x7 JOIN 
( SELECT edgeP1."0", edgeP1."5", edgeP1."6", edgeP1."7", edgeP1."8", edgeP1."10"
FROM 
( edge4x11 JOIN 
( SELECT edgeP9."0", edgeP9."4", edgeP9."5", edgeP9."6", edgeP9."7", edgeP9."8", edgeP9."10", edgeP9."11"
FROM 
( edge1x8 JOIN 
( edge1x4 JOIN 
( edge7x11 JOIN 
( edge6x11 JOIN 
( SELECT edgeP3."0", edgeP3."1", edgeP3."4", edgeP3."5", edgeP3."6", edgeP3."7", edgeP3."8", edgeP3."10", edgeP3."11"
FROM 
( edge1x9 JOIN 
( SELECT edgeP12."0", edgeP12."1", edgeP12."4", edgeP12."5", edgeP12."6", edgeP12."7", edgeP12."8", edgeP12."9", edgeP12."10", edgeP12."11"
FROM 
( edge3x9 JOIN 
( edge5x8 JOIN 
( edge7x8 JOIN 
...
( edge5x10 JOIN 
( edge6x9 JOIN 
( SELECT edgeP2."0", edgeP2."1", edgeP2."3", edgeP2."4", edgeP2."5", edgeP2."6", edgeP2."7", edgeP2."8", edgeP2."9", edgeP2."10", edgeP2."11"
FROM 
( edge7x12 JOIN 
( edge6x12 JOIN 
( SELECT edge0x8."0", edge1x12."1", edge3x6."3", edge4x10."4", edge5x12."5", edge3x6."6", edge2x7."7", edge8x10."8", edge5x9."9", edge8x10."10", edge2x11."11", edge5x12."12"
FROM 
( edge2x10 JOIN 
( edge0x2 JOIN 
( edge10x11 JOIN 
...
ON edge5x9."5"  = edge5x12."5"  AND edge5x9."9"  = edge5x9."9" ) 
...
ON edge8x9."8"  = edge8x10."8"  AND edge8x9."9"  = edge5x9."9" ) 
ON edge4x9."4"  = edge4x10."4"  AND edge4x9."9"  = edge5x9."9" ) 
...
ON edge0x9."0"  = edge0x8."0"  AND edge0x9."9"  = edge5x9."9" ) 
...
ON edge9x12."9"  = edge5x9."9"  AND edge9x12."12"  = edge5x12."12" ) 
ON edge9x10."9"  = edge5x9."9"  AND edge9x10."10"  = edge8x10."10" ) 
ON edge9x11."9"  = edge5x9."9"  AND edge9x11."11"  = edge2x11."11" ) 
...
ON edge2x9."2"  = edge2x11."2"  AND edge2x9."9"  = edge5x9."9" ) 
...
ON edge2x10."2"  = edge2x11."2"  AND edge2x10."10"  = edge8x10."10" ) 
WHERE (1=1) ) AS edgeP2
ON edge6x12."6"  = edgeP2."6"  AND edge6x12."12"  = edgeP2."12" ) 
...
WHERE (1=1) ) AS edgeP1
ON edge4x11."4"  = edgeP1."4"  AND edge4x11."11"  = edgeP1."11" ) 
