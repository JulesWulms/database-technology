...
ON edge5x8."5"  = edge5x12."5"  AND edge5x8."8"  = edge8x10."8" ) 
ON edge1x9."1"  = edge1x12."1"  AND edge1x9."9"  = edge8x9."9" ) 
ON edge4x11."4"  = edge4x10."4"  AND edge4x11."11"  = edge2x11."11" ) 
ON edge5x9."5"  = edge5x12."5"  AND edge5x9."9"  = edge8x9."9" ) 
ON edge7x11."7"  = edge2x7."7"  AND edge7x11."11"  = edge2x11."11" ) 
ON edge1x4."1"  = edge1x12."1"  AND edge1x4."4"  = edge4x10."4" ) 
ON edge3x9."3"  = edge3x6."3"  AND edge3x9."9"  = edge8x9."9" ) 
ON edge2x10."2"  = edge2x11."2"  AND edge2x10."10"  = edge8x10."10" ) 
ON edge0x7."0"  = edge0x8."0"  AND edge0x7."7"  = edge2x7."7" ) 
ON edge7x10."7"  = edge2x7."7"  AND edge7x10."10"  = edge8x10."10" ) 
ON edge6x8."6"  = edge3x6."6"  AND edge6x8."8"  = edge8x10."8" ) 
ON edge1x8."1"  = edge1x12."1"  AND edge1x8."8"  = edge8x10."8" ) 
ON edge6x7."6"  = edge3x6."6"  AND edge6x7."7"  = edge2x7."7" ) 
WHERE (1=1)
