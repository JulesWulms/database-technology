...
FROM 
( edge12x23 JOIN 
( SELECT edgeP22."12", edgeP22."18", edgeP22."23"
FROM 
( edge16x24 JOIN 
( SELECT edgeP8."12", edgeP8."16", edgeP8."18", edgeP8."23", edgeP8."24"
FROM 
( edge11x22 JOIN 
( SELECT edgeP14."11", edgeP14."12", edgeP14."16", edgeP14."18", edgeP14."23", edgeP14."22", edgeP14."24"
FROM 
( edge8x12 JOIN 
( SELECT edgeP15."8", edgeP15."11", edgeP15."12", edgeP15."16", edgeP15."18", edgeP15."23", edgeP15."22", edgeP15."24"
FROM 
( edge6x14 JOIN 
( SELECT edgeP3."6", edgeP3."8", edgeP3."11", edgeP3."12", edgeP3."14", edgeP3."16", edgeP3."18", edgeP3."23", edgeP3."22", edgeP3."24"
FROM 
( edge15x22 JOIN 
( SELECT edgeP26."6", edgeP26."8", edgeP26."11", edgeP26."12", edgeP26."14", edgeP26."15", edgeP26."16", edgeP26."18", edgeP26."23", edgeP26."22", edgeP26."24"
FROM 
( edge3x24 JOIN 
( SELECT edgeP9."3", edgeP9."6", edgeP9."8", edgeP9."11", edgeP9."12", edgeP9."14", edgeP9."15", edgeP9."16", edgeP9."18", edgeP9."23", edgeP9."22", edgeP9."24"
FROM 
( edge0x26 JOIN 
( SELECT edgeP7."0", edgeP7."3", edgeP7."6", edgeP7."8", edgeP7."11", edgeP7."12", edgeP7."14", edgeP7."15", edgeP7."16", edgeP7."18", edgeP7."23", edgeP7."22", edgeP7."24", edgeP7."26"
FROM 
( edge9x12 JOIN 
( SELECT edgeP13."0", edgeP13."3", edgeP13."6", edgeP13."8", edgeP13."9", edgeP13."11", edgeP13."12", edgeP13."14", edgeP13."15", edgeP13."16", edgeP13."18", edgeP13."23", edgeP13."22", edgeP13."24", edgeP13."26"
FROM 
( edge7x24 JOIN 
( SELECT edgeP21."0", edgeP21."3", edgeP21."6", edgeP21."7", edgeP21."8", edgeP21."9", edgeP21."11", edgeP21."12", edgeP21."14", edgeP21."15", edgeP21."16", edgeP21."18", edgeP21."23", edgeP21."22", edgeP21."24", edgeP21."26"
FROM 
( edge8x13 JOIN 
( SELECT edgeP20."0", edgeP20."3", edgeP20."6", edgeP20."7", edgeP20."8", edgeP20."9", edgeP20."11", edgeP20."12", edgeP20."13", edgeP20."14", edgeP20."15", edgeP20."16", edgeP20."18", edgeP20."23", edgeP20."22", edgeP20."24", edgeP20."26"
FROM 
( edge14x21 JOIN 
( SELECT edgeP10."0", edgeP10."3", edgeP10."6", edgeP10."7", edgeP10."8", edgeP10."9", edgeP10."11", edgeP10."12", edgeP10."13", edgeP10."14", edgeP10."15", edgeP10."16", edgeP10."18", edgeP10."21", edgeP10."23", edgeP10."22", edgeP10."24", edgeP10."26"
FROM 
( edge7x20 JOIN 
( edge14x24 JOIN 
( SELECT edgeP1."0", edgeP1."3", edgeP1."6", edgeP1."7", edgeP1."8", edgeP1."9", edgeP1."11", edgeP1."12", edgeP1."13", edgeP1."14", edgeP1."15", edgeP1."16", edgeP1."18", edgeP1."21", edgeP1."20", edgeP1."23", edgeP1."22", edgeP1."24", edgeP1."26"
FROM 
( edge5x10 JOIN 
( edge15x24 JOIN 
( edge18x20 JOIN 
( edge9x23 JOIN 
( SELECT edgeP2."0", edgeP2."3", edgeP2."5", edgeP2."6", edgeP2."7", edgeP2."8", edgeP2."9", edgeP2."10", edgeP2."11", edgeP2."12", edgeP2."13", edgeP2."14", edgeP2."15", edgeP2."16", edgeP2."18", edgeP2."21", edgeP2."20", edgeP2."23", edgeP2."22", edgeP2."24", edgeP2."26"
FROM 
( edge1x21 JOIN 
( SELECT edgeP4."0", edgeP4."1", edgeP4."3", edgeP4."5", edgeP4."6", edgeP4."7", edgeP4."8", edgeP4."9", edgeP4."10", edgeP4."11", edgeP4."12", edgeP4."13", edgeP4."14", edgeP4."15", edgeP4."16", edgeP4."18", edgeP4."21", edgeP4."20", edgeP4."23", edgeP4."22", edgeP4."24", edgeP4."26"
FROM 
( edge2x21 JOIN 
( SELECT edgeP25."0", edgeP25."1", edgeP25."2", edgeP25."3", edgeP25."5", edgeP25."6", edgeP25."7", edgeP25."8", edgeP25."9", edgeP25."10", edgeP25."11", edgeP25."12", edgeP25."13", edgeP25."14", edgeP25."15", edgeP25."16", edgeP25."18", edgeP25."21", edgeP25."20", edgeP25."23", edgeP25."22", edgeP25."24", edgeP25."26"
FROM 
( edge4x20 JOIN 
( edge14x15 JOIN 
( edge10x26 JOIN 
...
( edge0x22 JOIN 
( edge6x7 JOIN 
( SELECT edgeP17."0", edgeP17."1", edgeP17."2", edgeP17."3", edgeP17."4", edgeP17."5", edgeP17."6", edgeP17."7", edgeP17."8", edgeP17."9", edgeP17."10", edgeP17."11", edgeP17."12", edgeP17."13", edgeP17."14", edgeP17."15", edgeP17."16", edgeP17."18", edgeP17."21", edgeP17."20", edgeP17."23", edgeP17."22", edgeP17."24", edgeP17."26"
FROM 
( edge19x25 JOIN 
( edge13x15 JOIN 
( edge10x25 JOIN 
...
( edge18x25 JOIN 
( edge15x18 JOIN 
( SELECT edge0x8."0", edge1x6."1", edge2x11."2", edge3x19."3", edge4x24."4", edge3x5."5", edge1x6."6", edge7x16."7", edge8x21."8", edge8x9."9", edge10x16."10", edge2x11."11", edge12x19."12", edge10x13."13", edge14x17."14", edge11x15."15", edge7x16."16", edge12x19."19", edge18x23."18", edge8x21."21", edge20x23."20", edge18x23."23", edge6x22."22", edge7x25."25", edge11x24."24", edge25x26."26"
FROM 
( edge17x20 JOIN 
( edge24x25 JOIN 
( edge4x19 JOIN 
...
ON edge18x25."18"  = edgeP17."18"  AND edge18x25."25"  = edgeP17."25" ) 
ON edge2x19."2"  = edgeP17."2"  AND edge2x19."19"  = edgeP17."19" ) 
ON edge6x21."6"  = edgeP17."6"  AND edge6x21."21"  = edgeP17."21" ) 
ON edge22x26."22"  = edgeP17."22"  AND edge22x26."26"  = edgeP17."26" ) 
ON edge1x11."1"  = edgeP17."1"  AND edge1x11."11"  = edgeP17."11" ) 
ON edge11x13."11"  = edgeP17."11"  AND edge11x13."13"  = edgeP17."13" ) 
ON edge19x21."19"  = edgeP17."19"  AND edge19x21."21"  = edgeP17."21" ) 
ON edge1x3."1"  = edgeP17."1"  AND edge1x3."3"  = edgeP17."3" ) 
ON edge10x25."10"  = edgeP17."10"  AND edge10x25."25"  = edgeP17."25" ) 
ON edge13x15."13"  = edgeP17."13"  AND edge13x15."15"  = edgeP17."15" ) 
ON edge19x25."19"  = edgeP17."19"  AND edge19x25."25"  = edgeP17."25" ) 
WHERE (1=1) ) AS edgeP25
ON edge6x7."6"  = edgeP25."6"  AND edge6x7."7"  = edgeP25."7" ) 
ON edge0x22."0"  = edgeP25."0"  AND edge0x22."22"  = edgeP25."22" ) 
ON edge5x15."5"  = edgeP25."5"  AND edge5x15."15"  = edgeP25."15" ) 
ON edge10x26."10"  = edgeP25."10"  AND edge10x26."26"  = edgeP25."26" ) 
ON edge14x15."14"  = edgeP25."14"  AND edge14x15."15"  = edgeP25."15" ) 
ON edge4x20."4"  = edgeP25."4"  AND edge4x20."20"  = edgeP25."20" ) 
WHERE (1=1) ) AS edgeP4
ON edge2x21."2"  = edgeP4."2"  AND edge2x21."21"  = edgeP4."21" ) 
WHERE (1=1) ) AS edgeP2
ON edge1x21."1"  = edgeP2."1"  AND edge1x21."21"  = edgeP2."21" ) 
WHERE (1=1) ) AS edgeP1
ON edge9x23."9"  = edgeP1."9"  AND edge9x23."23"  = edgeP1."23" ) 
ON edge18x20."18"  = edgeP1."18"  AND edge18x20."20"  = edgeP1."20" ) 
ON edge15x24."15"  = edgeP1."15"  AND edge15x24."24"  = edgeP1."24" ) 
ON edge5x10."5"  = edgeP1."5"  AND edge5x10."10"  = edgeP1."10" ) 
WHERE (1=1) ) AS edgeP10
ON edge14x24."14"  = edgeP10."14"  AND edge14x24."24"  = edgeP10."24" ) 
...
ON edge8x13."8"  = edgeP21."8"  AND edge8x13."13"  = edgeP21."13" ) 
WHERE (1=1) ) AS edgeP13
ON edge7x24."7"  = edgeP13."7"  AND edge7x24."24"  = edgeP13."24" ) 
WHERE (1=1) ) AS edgeP7
ON edge9x12."9"  = edgeP7."9"  AND edge9x12."12"  = edgeP7."12" ) 
WHERE (1=1) ) AS edgeP9
ON edge0x26."0"  = edgeP9."0"  AND edge0x26."26"  = edgeP9."26" ) 
WHERE (1=1) ) AS edgeP26
ON edge3x24."3"  = edgeP26."3"  AND edge3x24."24"  = edgeP26."24" ) 
WHERE (1=1) ) AS edgeP3
ON edge15x22."15"  = edgeP3."15"  AND edge15x22."22"  = edgeP3."22" ) 
...
WHERE (1=1) ) AS edgeP8
ON edge11x22."11"  = edgeP8."11"  AND edge11x22."22"  = edgeP8."22" ) 
WHERE (1=1) ) AS edgeP22
ON edge16x24."16"  = edgeP22."16"  AND edge16x24."24"  = edgeP22."24" ) 
WHERE (1=1) ) AS edgeP24
ON edge12x23."12"  = edgeP24."12"  AND edge12x23."23"  = edgeP24."23" ) 
