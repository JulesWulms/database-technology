...
ON edge4x10."4"  = edge4x9."4"  AND edge4x10."10"  = edge5x10."10" ) 
ON edge4x8."4"  = edge4x9."4"  AND edge4x8."8"  = edge3x8."8" ) 
ON edge3x6."3"  = edge3x8."3"  AND edge3x6."6"  = edge2x6."6" ) 
ON edge0x3."0"  = edge0x7."0"  AND edge0x3."3"  = edge3x8."3" ) 
ON edge1x5."1"  = edge1x4."1"  AND edge1x5."5"  = edge5x10."5" ) 
ON edge1x10."1"  = edge1x4."1"  AND edge1x10."10"  = edge5x10."10" ) 
WHERE (1=1)
