...
FROM 
( edge0x4 JOIN 
( SELECT edgeP2."0", edgeP2."4", edgeP2."5"
FROM 
( edge1x11 JOIN 
( SELECT edgeP14."0", edgeP14."1", edgeP14."4", edgeP14."5", edgeP14."11"
FROM 
( edge2x4 JOIN 
( SELECT edgeP6."0", edgeP6."1", edgeP6."2", edgeP6."4", edgeP6."5", edgeP6."11"
FROM 
( edge12x14 JOIN 
( edge2x14 JOIN 
( edge1x4 JOIN 
( SELECT edgeP7."0", edgeP7."1", edgeP7."2", edgeP7."4", edgeP7."5", edgeP7."11", edgeP7."12", edgeP7."14"
FROM 
( edge4x6 JOIN 
( edge1x2 JOIN 
( edge0x6 JOIN 
( edge11x12 JOIN 
( SELECT edgeP3."0", edgeP3."1", edgeP3."2", edgeP3."4", edgeP3."5", edgeP3."6", edgeP3."11", edgeP3."12", edgeP3."14"
FROM 
( edge0x7 JOIN 
( edge2x7 JOIN 
( edge2x6 JOIN 
( edge4x12 JOIN 
( SELECT edgeP10."0", edgeP10."1", edgeP10."2", edgeP10."4", edgeP10."5", edgeP10."6", edgeP10."7", edgeP10."11", edgeP10."12", edgeP10."14"
FROM 
( edge3x4 JOIN 
( SELECT edgeP8."0", edgeP8."1", edgeP8."2", edgeP8."3", edgeP8."4", edgeP8."5", edgeP8."6", edgeP8."7", edgeP8."11", edgeP8."12", edgeP8."14"
FROM 
( edge6x10 JOIN 
( edge1x3 JOIN 
( edge1x12 JOIN 
...
WHERE (1=1) ) AS edgeP9
ON edge2x13."2"  = edgeP9."2"  AND edge2x13."13"  = edgeP9."13" ) 
...
ON edge2x11."2"  = edgeP9."2"  AND edge2x11."11"  = edgeP9."11" ) 
ON edge7x11."7"  = edgeP9."7"  AND edge7x11."11"  = edgeP9."11" ) 
ON edge1x14."1"  = edgeP9."1"  AND edge1x14."14"  = edgeP9."14" ) 
...
ON edge5x12."5"  = edgeP9."5"  AND edge5x12."12"  = edgeP9."12" ) 
...
ON edge0x6."0"  = edgeP7."0"  AND edge0x6."6"  = edgeP7."6" ) 
ON edge1x2."1"  = edgeP7."1"  AND edge1x2."2"  = edgeP7."2" ) 
ON edge4x6."4"  = edgeP7."4"  AND edge4x6."6"  = edgeP7."6" ) 
WHERE (1=1) ) AS edgeP6
ON edge1x4."1"  = edgeP6."1"  AND edge1x4."4"  = edgeP6."4" ) 
...
WHERE (1=1) ) AS edgeP2
ON edge1x11."1"  = edgeP2."1"  AND edge1x11."11"  = edgeP2."11" ) 
WHERE (1=1) ) AS edgeP11
ON edge0x4."0"  = edgeP11."0"  AND edge0x4."4"  = edgeP11."4" ) 
WHERE (1=1) ) AS edgeP4
WHERE (1=1)
