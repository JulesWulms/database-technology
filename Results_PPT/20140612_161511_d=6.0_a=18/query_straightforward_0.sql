...
ON edge3x8."3"  = edge3x7."3"  AND edge3x8."8"  = edge0x8."8" ) 
ON edge4x9."4"  = edge4x7."4"  AND edge4x9."9"  = edge7x9."9" ) 
ON edge8x9."8"  = edge0x8."8"  AND edge8x9."9"  = edge7x9."9" ) 
ON edge0x4."0"  = edge0x8."0"  AND edge0x4."4"  = edge4x7."4" ) 
ON edge5x8."5"  = edge5x6."5"  AND edge5x8."8"  = edge0x8."8" ) 
ON edge4x8."4"  = edge4x7."4"  AND edge4x8."8"  = edge0x8."8" ) 
ON edge1x3."1"  = edge1x6."1"  AND edge1x3."3"  = edge3x7."3" ) 
ON edge5x9."5"  = edge5x6."5"  AND edge5x9."9"  = edge7x9."9" ) 
ON edge4x6."4"  = edge4x7."4"  AND edge4x6."6"  = edge5x6."6" ) 
ON edge2x8."2"  = edge2x7."2"  AND edge2x8."8"  = edge0x8."8" ) 
ON edge0x1."0"  = edge0x8."0"  AND edge0x1."1"  = edge1x6."1" ) 
ON edge0x3."0"  = edge0x8."0"  AND edge0x3."3"  = edge3x7."3" ) 
